...
namespace Samples
{
    public class DrawerInitialSetupFragment : AndroidX.Fragment.App.Fragment, ExampleFragment, IDrawerChangeListener, AdapterView.IOnItemSelectedListener, CompoundButton.IOnCheckedChangeListener
	{
		...
		private View LoadMainContent(LayoutInflater inflater) {
			...
			AndroidX.AppCompat.Widget.Toolbar toolbar = (AndroidX.AppCompat.Widget.Toolbar)result.FindViewById(Resource.Id.drawerToolbar);
