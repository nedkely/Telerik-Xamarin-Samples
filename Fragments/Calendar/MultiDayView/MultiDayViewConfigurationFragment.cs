...
namespace Samples
{
    public class MultiDayViewConfigurationFragment : AndroidX.Fragment.App.Fragment, ExampleFragment
    {
        ...
        public class TimeSlotTappedListener : Java.Lang.Object, Com.Telerik.Widget.Calendar.Dayview.IDayViewTimeSlotTappedListener
        {
            ...
            public void OnTimeSlotTapped(long exactTime, long startTime, long endTime, params Java.Lang.Object[] parameters)
            {
                Calendar calendar = Calendar.Instance;
