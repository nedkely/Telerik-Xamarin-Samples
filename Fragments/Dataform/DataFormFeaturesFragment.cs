...
namespace Samples
{
	public class DataFormFeaturesFragment : AndroidX.Fragment.App.Fragment, ExampleFragment, CompoundButton.IOnCheckedChangeListener, AdapterView.IOnItemSelectedListener, IPropertyChangedListener, View.IOnClickListener {
