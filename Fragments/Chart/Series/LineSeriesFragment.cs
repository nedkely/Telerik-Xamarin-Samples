...
namespace Samples
{
	public class LineSeriesFragment : AndroidX.Fragment.App.Fragment, ExampleFragment
	{
		...
		private RadCartesianChartView createChart(){
			...
			//Create the line series and attach axes and value bindings.
			LineSeries lineSeries = new LineSeries();

			lineSeries.ValueBinding = new ValueBinding();
			lineSeries.CategoryBinding = new CategoryBinding();
			...
			lineSeries.HorizontalAxis = horizontalAxis;
